...
{
CrossServerEndpoint::CrossServerEndpoint(Schema_ComponentData* Data, ERPCType Type)
...
CrossServerEndpointACK::CrossServerEndpointACK(Schema_ComponentData* Data, ERPCType InType)
	: Type(InType)
{
	ReadFromSchema(Schema_GetComponentDataFields(Data));
}
